                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item active">Quote Requested</li>
                                        </ol>
                                    </div>
                                    <h1 class="h1-heading">Policies</h1>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <table id="basic-datatable" class="table table-striped dt-responsive nowrap w-100">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ \Carbon\Carbon::parse($policy->created_at)->format('M d, Y') }}</td>
                                                <td>{{ \Carbon\Carbon::parse($policy->expiry_date)->format('M d, Y') }}</td>
                                                <td>{{ $policy->quotation?->policy->name }}
                                                 <br><small>
                                                    {{ $policy->quotation?->policyType->type }}
                                                 </small>
                                                </td>
                                                <td>{{ $policy->status }}</td>
                                                <td>
                                                    <a class="btn btn-warning" href="{{ route('customer.policy.show',$policy->id) }}">
