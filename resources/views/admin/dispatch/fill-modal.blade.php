...
<div id="dispatch-fill-modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="fullWidthModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('admin.dispatch.add') }}" method="POST" id="dispatchForm">
                   <input type="hidden" name="id" value="{{$dispatch->id}}" />
                    ...
                    <div class="row m-2">
                        ...
                        <div class="col-9">
                            <input type="date" required class="form-control" name="dispatch_date">
                        </div>
                    </div>
            ...
            <div class="modal-footer">
                <button type="submit" form="dispatchForm" class="btn btn-success">Submit</button>
