            ...
            <div class="col-12">
                <div class="page-title-box">
                    <div class="page-title-right">
                        ...
                        @can('Create Agency')
                        <a href="{{ route('admin.agency.create') }}" class="btn btn-sm btn-primary float-end"><i
                                ...
                                <table id="basic-datatable" class="table table-striped dt-responsive nowrap w-100">
                                    <thead class="bg-dark">
                                        <tr>
                                            ...
                                            <th class="bg-secondary text-white">Agency</th>
                                                ...
                                                <td>
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input checkbox-row"
                                                            name="rows" id="customCheck{{ $agency->id }}"
                                                            value="{{ $agency->id }}">
                                                        <label class="form-check-label"
                                                            for="customCheck{{ $agency->id }}">&nbsp;</label>
                                                    </div>
                                                <td class="table-user">
                                                        {{ $agency->agency }}
                                                </td>
                                                <td>
                                                    <button class="btn btn-sm {{ $agency->enabled == true ? "btn-primary" : "btn-danger" }}" disabled>{{ $agency->enabled == true ? "Enabled" : "Disabled" }}</button>
                                                </td>
                                                <td class="text-end">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end">
                                                        ...
                                                        @can('Edit Agency')
                                                        <a href="{{ route('admin.agency.edit', $agency) }}"
                                                            class="dropdown-item">
                                                            <i class="mdi mdi-pencil me-1"></i>Edit Agency</a>
                                                        @endcan
                                                        ...
                                                        <a href="javascript:void(0);"
                                                            ...
                                                            class="dropdown-item">
                                                            <i class="mdi mdi-delete me-1"></i>Delete Agency</a>
                                                        @endcan
        ...
        $("#delete-all").click(function(e) {
            rows = [], $("input:checkbox[name=rows]:checked").each(function() {
                ...
                t.isConfirmed && ($("#delete-all").text("Deleting..."), e.preventDefault(), $.ajax({
                    type: "POST",
                    dataType: "json",
                    url: "{{ route('admin.agency.bulk-delete') }}",
                    data: {
                        agencies: rows,
                        _token: "{{ csrf_token() }}"
                    },
