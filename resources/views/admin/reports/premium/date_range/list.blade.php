...
@section('title', 'Date Range wise Report')
@section('head')
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title">Date Range wise Reports</h4>
                </div>
            </div>
        </div>
                                ...
                                <table id="basic-datatable" class="table table-striped dt-responsive nowrap w-100">
                                    <thead class="bg-dark">
                                        <tr>
                                            ...
                                            <th class="bg-secondary text-white">{{ __('Company') }}</th>
                                    ...
                                    <tbody>
                                        @foreach ($policies as $policy)
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $policy->amount }}</td>
                                                <td>{{ company_data($policy->meta_value) }}</td>
                                                <td class="text-end">
...
@endsection
@push('filter')
   @include('admin.reports.premium.date_range.filter')
@endpush
@push('scripts')
