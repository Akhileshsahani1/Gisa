                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <a href="{{ route('admin.users.create') }}"
                            class="btn btn-sm btn-primary float-end"><i class="mdi mdi-plus"></i> Add New User</a>
                                ...
                                <table id="basic-datatable" class="table table-striped dt-responsive nowrap w-100">
                                    <thead class="bg-dark">
                                         <tr>
                                            ...
                                            <th class="bg-secondary text-white">Roles</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <button type="button" onclick="confirmDelete({{$user->id}})" class="btn btn-sm btn-danger">Delete </button>
