<div class="card">
    <div class="card-header bg-secondary text-white pb-0">
        <h4 class="card-title">Two Wheeler Package Policy</h4>
    </div>
    ...
    <div class="card-body pt-1">
        ...
        <div class="row">
            <div class="form-group col-sm-12">
                ...
                <select disabled  id="business_type"
            ...
            <div class="form-group col-sm-6">
                ...
                <select disabled id="sales_executive_id"
            ...
            <div class="form-group col-sm-6">
                <label class="col-form-label" for="service_executive_id">Service Executive <span
                        class="text-danger">*</span></label>
                <select disabled  id="service_executive_id"
        ...
        <div class="row">
            <div class="form-group col-sm-6">
                ...
                <input name="registration_number" id="registration_number" type="text"
                    ...
                    value="{{ policy_data($policy->id, 'registration_number') ? policy_data($policy->id, 'registration_number') : motor_form($quotation?->id, 'registration_number')  }}" placeholder="Enter Registration Number">
            ...
            <div class="form-group col-sm-6">
                ...
                <select  name="year_of_manufacture" id="year_of_manufacture"
                    ...
                    <option value="{{ old('year_of_manufacture',policy_data($policy->id,'year_of_manufacture')) }}">Choose Year of Manufacture</option>
                    @php
                        $year = 1900;
                        $currentYear = date('Y');
                    @endphp
        ...
        <div class="row">
            ...
            <div class="form-group col-sm-6">
                ...
                <input id="previous_policy_expiry_date" type="date"
                    ...
                    namex="previous_policy_expiry_date"
                    readonly
            ...
            <div class="form-group col-sm-6">
                ...
                <select name="previous_insurance_company" id="previous_insurance_company"
                    ...
                    <option value="{{ old('previous_insurance_company',policy_data($policy->id,'previous_insurance_company')) }}">Choose Previous Insurance Company</option>
            ...
            <div class="form-group col-sm-6">
                ...
                <select disabled namex="previous_ncb" id="previous_ncb"
    ...
    <div class="card-body pt-1">
        <div class="row">
            ...
            <div class="form-group col-sm-6">
                ...
                <input id="gross_tp"
                 type="number"
                  class="form-control @error('gross_tp') is-invalid @enderror"
                  name="gross_tp" value="{{ old('gross_tp', policy_data($policy->id,'gross_tp')) }}" placeholder="Enter Gross TP">
                @error('gross_tp')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
            ...
            <div class="form-group col-sm-6">
                ...
                <input id="gst_od"  type="number" class="form-control @error('gst_od') is-invalid @enderror" name="gst_od" value="{{ old('gst_od',  motor_form($quotation?->id,'gst_18') ) }}" placeholder="Enter GST on OD">
                @error('gst_od')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
            ...
            <div class="form-group col-sm-6">
                ...
                <input id="gst_tp" type="number" class="form-control @error('gst_tp') is-invalid @enderror" name="gst_tp" value="{{ old('gst_tp', policy_data($policy->id,'gst_tp')) }}" placeholder="Enter GST on TP">
                @error('gst_tp')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
            ...
            <div class="form-group col-sm-6">
                ...
                <input id="net_premium" type="number" class="form-control @error('net_premium') is-invalid @enderror"
                 name="net_premium"
                 value="{{ old('net_premium', policy_data($policy->id,'net_premium')  ) }}" placeholder="Enter Net Premium">
                @error('net_premium')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
            ...
            <div class="form-group col-sm-6">
                ...
                name="gross_premium"
                value="{{ old('gross_premium',  policy_data($policy->id,'gross_premium') ) }}"
    ...
    <div class="card-body">
        <div class="row">
            <div class="form-group col-md-6">
                ...
                <a class="btn btn-warning float-end m-1"
                   download
                   href="{{ asset('storage/uploads/quotation_policy/'.$policy->id.'/'.policy_data($policy->id,'proposal_form') )}}">
            ...
            <div class="form-group col-md-6">
                ...
                <a class="btn btn-warning float-end m-1"
                   download
                   href="{{ asset('storage/uploads/quotation_policy/'.$policy->id.'/'.policy_data($policy->id,'rc') )}}">
                   <i class="mdi mdi-download"></i>
                </a>
                @endif
            ...
            <div class="form-group col-md-6">
                ...
                <a class="btn btn-warning float-end m-1"
                   download
                   href="{{ asset('storage/uploads/quotation_policy/'.$policy->id.'/'.policy_data($policy->id,'previous_policy') )}}">
                   <i class="mdi mdi-download"></i>
                </a>
                @endif
            ...
            <div class="form-group col-md-6">
                ...
                <a class="btn btn-warning float-end m-1"
                   download
                   href="{{ asset('storage/uploads/quotation_policy/'.$policy->id.'/'.policy_data($policy->id,'pre_inspection_report') )}}">
                   <i class="mdi mdi-download"></i>
                </a>
                @endif
            ...
            <div class="form-group col-md-6">
                ...
                <a class="btn btn-warning float-end m-1"
                   download
                   href="{{ asset('storage/uploads/quotation_policy/'.$policy->id.'/'.policy_data($policy->id,'invoice_copy') )}}">
                   <i class="mdi mdi-download"></i>
                </a>
                @endif
            ...
            <div class="form-group col-md-6">
                ...
                <a class="btn btn-warning float-end m-1"
                   download
                   href="{{ asset('storage/uploads/quotation_policy/'.$policy->id.'/'.policy_data($policy->id,'policy_copy') )}}">
                   <i class="mdi mdi-download"></i>
                </a>
                @endif
            ...
            <div class="form-group col-md-6">
                ...
                <a class="btn btn-warning float-end m-1"
                   download
                   href="{{ asset('storage/uploads/quotation_policy/'.$policy->id.'/'.policy_data($policy->id,'other') )}}">
                   <i class="mdi mdi-download"></i>
                </a>
                @endif
