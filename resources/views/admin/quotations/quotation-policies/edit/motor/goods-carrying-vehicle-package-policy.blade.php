<div class="card">
    <div class="card-header bg-secondary text-white pb-0">
        <h4 class="card-title">Goods Carrying Vehicle Package Policy</h4>
    </div>
...
<div class="card">
    ...
    <div class="card-body pt-1">
        <div class="row">
            ...
            <div class="form-group col-sm-6">
                <label class="col-form-label" for="gvw">Gross Vehicle Weight (G.V.W) <span
                        class="text-danger">*</span></label>
                <input id="gvw" type="text"
                    class="form-control @error('gvw') is-invalid @enderror" name="gvw"
                    value="{{ old('gvw', isset($quotation->gvw) ? $quotation->gvw : '') }}" placeholder="Enter Vehicle Gross Vehicle Weight (G.V.W)">
                @error('gvw')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
