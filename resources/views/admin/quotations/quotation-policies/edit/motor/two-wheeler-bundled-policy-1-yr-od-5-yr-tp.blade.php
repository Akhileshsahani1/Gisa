<div class="card">
    <div class="card-header bg-secondary text-white pb-0">
        <h4 class="card-title">Two Wheeler Bundled Policy ( 1 Yr OD + 5 Yr TP )</h4>
    </div>
            ...
            <div class="form-group col-sm-6">
                <label class="col-form-label" for="cubic_capacity">Cubic Capacity (CC) <span
                 ...
                 <input id="cubic_capacity" type="text"
                    ...
                    value="{{ old('cubic_capacity', isset($quotation->cubic_capacity) ? $quotation->cubic_capacity : '') }}" placeholder="Enter Vehicle Cubic Capacity">
        ...
        <div class="row">
            <div class="form-group col-sm-6">
                ...
                <input id="previous_od_policy_no" type="text"
                    ...
                    value="{{ old('previous_od_policy_no', isset($quotation->previous_od_policy_no) ? $quotation->previous_od_policy_no : '') }}"
            ...
            <div class="form-group col-sm-6">
                ...
                <input id="previous_od_policy_expiry_date" type="date"
                    ...
                    value="{{ old('previous_od_policy_expiry_date', isset($quotation->previous_od_policy_expiry_date) ? $quotation->previous_od_policy_expiry_date : '') }}"
            ...
            <div class="form-group col-sm-6">
                <label class="col-form-label" for="previous_od_ncb">Previous NCB <span class="text-danger">*</span></label>
                <select name="previous_od_ncb" id="previous_od_ncb"
                    class="form-select business_type_new @error('previous_od_ncb') is-invalid @enderror">
                    <option value="">Choose Previous NCB</option>
                    <option value="20%" {{ old('previous_od_ncb', isset($quotation->previous_od_ncb) ? $quotation->previous_od_ncb : '') == '20%' ? 'selected' : '' }}>20%</option>
                    <option value="25%" {{ old('previous_od_ncb', isset($quotation->previous_od_ncb) ? $quotation->previous_od_ncb : '') == '25%' ? 'selected' : '' }}>25% </option>
                    <option value="35%" {{ old('previous_od_ncb', isset($quotation->previous_od_ncb) ? $quotation->previous_od_ncb : '') == '35%' ? 'selected' : '' }}>35%</option>
                    <option value="45%" {{ old('previous_od_ncb', isset($quotation->previous_od_ncb) ? $quotation->previous_od_ncb : '') == '45%' ? 'selected' : '' }}>45% </option>
                    <option value="50%" {{ old('previous_od_ncb', isset($quotation->previous_od_ncb) ? $quotation->previous_od_ncb : '') == '50%' ? 'selected' : '' }}>50%</option>
                </select>
                @error('previous_ncb')
                    <div class="invalid-feedback">
                        {{ $message }}
...
<div class="card">
    ...
    <div class="card-body pt-1">
        <div class="row">
            ...
            <div class="form-group col-sm-6">
                <label for="od_policy_start_date" class="col-form-label">OD Policy Start
                    Date </label>
                <input id="od_policy_start_date" type="date"
                    class="form-control @error('od_policy_start_date') is-invalid @enderror"
                    name="od_policy_start_date"
                    value="{{ old('od_policy_start_date', isset($quotation->od_policy_start_date) ? $quotation->od_policy_start_date : '') }}"
                    placeholder="OD Policy Start Date">
                @error('od_policy_start_date')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
                @enderror
            ...
            <div class="form-group col-sm-6">
                <label for="od_policy_expiry_date" class="col-form-label">OD Policy Expiry
                    Date </label>
                <input id="od_policy_expiry_date" type="date"
                    class="form-control @error('od_policy_expiry_date') is-invalid @enderror"
                    name="od_policy_expiry_date"
                    value="{{ old('od_policy_expiry_date', isset($quotation->od_policy_expiry_date) ? $quotation->od_policy_expiry_date : '') }}"
                    placeholder="OD Policy Expiry Date">
                @error('od_policy_expiry_date')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
                @enderror
            ...
            <div class="form-group col-sm-6">
                <label for="tp_policy_start_date" class="col-form-label">TP Policy Start
                    Date </label>
                <input id="tp_policy_start_date" type="date"
                    class="form-control @error('tp_policy_start_date') is-invalid @enderror"
                    name="tp_policy_start_date"
                    value="{{ old('tp_policy_start_date', isset($quotation->tp_policy_start_date) ? $quotation->tp_policy_start_date : '') }}"
                    placeholder="TP Policy Start Date">
                @error('tp_policy_start_date')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
                @enderror
            ...
            <div class="form-group col-sm-6">
                <label for="tp_policy_expiry_date" class="col-form-label">TP Policy Expiry
                    Date </label>
                <input id="tp_policy_expiry_date" type="date"
                    class="form-control @error('tp_policy_expiry_date') is-invalid @enderror"
                    name="tp_policy_expiry_date"
                    value="{{ old('tp_policy_expiry_date', isset($quotation->tp_policy_expiry_date) ? $quotation->tp_policy_expiry_date : '') }}"
                    placeholder="TP Policy Expiry Date">
                @error('tp_policy_expiry_date')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
                @enderror
