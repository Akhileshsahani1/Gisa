<div class="card">
    <div class="card-header bg-secondary text-white pb-0">
        <h4 class="card-title">Private Car Bundled Policy ( 1 Yr OD + 3 Yr TP )</h4>
    </div>
        ...
        <div class="row">
            ...
            <div class="form-group col-sm-6">
                ...
                <input id="od_policy_expiry_date" type="date"
                    class="form-control @error('od_policy_expiry_date', isset($quotation->od_policy_expiry_date) ? $quotation->od_policy_expiry_date : '') is-invalid @enderror"
                    name="od_policy_expiry_date"
                    value="{{ old('od_policy_expiry_date') }}"
