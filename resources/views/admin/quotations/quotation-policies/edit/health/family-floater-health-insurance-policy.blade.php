<div class="card">
    <div class="card-header bg-secondary text-white pb-0">
        <h4 class="card-title">Family Floater Health Insurance Policy</h4>
    </div>
...
<div class="card">
    ...
    <div class="card-body pt-1">
        <div class="row">
            <div class="form-group col-sm-12">
                <label for="family_size" class="col-form-label">Family Size</label>
                <input id="family_size" type="text" class="form-control @error('family_size') is-invalid @enderror" name="family_size" value="{{ old('family_size', isset($quotation->family_size) ? $quotation->family_size : '') }}" placeholder="Family Size">
                @error('family_size')
...
<div class="card">
    ...
    <div class="card-body pt-1">
        <div class="row">
            ...
            <div class="form-group col-sm-6">
                <label for="previous_cumulative_bonus" class="col-form-label">Previous Cumulative Bonus</label>
                <input id="previous_cumulative_bonus" type="number"
                    class="form-control business_type_new @error('previous_cumulative_bonus') is-invalid @enderror"
                    name="previous_cumulative_bonus"
                    value="{{ old('previous_cumulative_bonus') }}"
                    placeholder="Previous Cumulative Bonus">
                @error('previous_cumulative_bonus')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
                @enderror
...
<div class="card">
    ...
    <div class="card-body pt-1">
        <div class="row">           
            ...
            <div class="form-group col-sm-6">
                <label for="cumulative_bonus" class="col-form-label">Cumulative Bonus</label>
                <input id="cumulative_bonus" type="number"
                    class="form-control @error('cumulative_bonus') is-invalid @enderror"
                    name="cumulative_bonus"
                    value="{{ old('cumulative_bonus', isset($quotation->cumulative_bonus) ? $quotation->cumulative_bonus : '') }}"
