<div class="card">
    <div class="card-header bg-secondary text-white pb-0">
        <h4 class="card-title">My Home All Risk Insurance Policy</h4>
    </div>
...
<div class="card">
    ...
    <div class="card-body">
        <div class="row">
            ...
            <div class="form-group col-md-6">
                <label for="list_of_items" class="col-form-label">Upload List of Items </label>
                <input id="list_of_items" type="file"
                    class="form-control @error('list_of_items') is-invalid @enderror" name="list_of_items">
                @error('list_of_items')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
