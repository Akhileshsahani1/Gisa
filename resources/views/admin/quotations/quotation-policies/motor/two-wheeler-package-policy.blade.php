    ...
    <div class="card-body pt-1">
        ...
        <div class="row">
            <div class="form-group col-sm-12">
                ...
                <select readonly name="business_type"  id="business_type"
            ...
            <input type="hidden" name="sales_executive_id" value="{{ $quotation->sales_executive_id }}">
            <input type="hidden" name="service_executive_id" value="{{ $quotation->service_executive_id }}">
            <!-- <div class="form-group col-sm-6">
                <label class="col-form-label" for="sales_executive_id">Sales Executive <span
                        class="text-danger">*</span></label>
                <select readonly name="sales_executive_id" id="sales_executive_id"
            ...
            <div class="form-group col-sm-6">
                <label class="col-form-label" for="service_executive_id">Service Executive <span
                        class="text-danger">*</span></label>
                <select readonly name="service_executive_id"  id="service_executive_id"
    ...
    <div class="card-body pt-1">
        ...
        <div class="row">
            ...
            <div class="form-group col-sm-6">
                ...
                <input readonly name="make" id="make" type="text" class="form-control @error('make') is-invalid @enderror"
            ...
            <div class="form-group col-sm-6">
                ...
                <input readonly name="model" id="model" type="text" class="form-control @error('model') is-invalid @enderror"
            ...
            <div class="form-group col-sm-6">
                <label class="col-form-label" for="cubic_capacity">Cubic Capacity (CC) <span
                        class="text-danger">*</span></label>
                <input readonly name="cubic_capacity" id="cubic_capacity" type="text"
            ...
            <div class="form-group col-sm-6">
                <label class="col-form-label" for="registration_date">Registration Date <span
                        class="text-danger">*</span></label>
                <input readonly name="registration_date" id="registration_date" type="date"
        ...
        <div class="row">
            ...
            <div class="form-group col-sm-6">
                <label for="previous_policy_expiry_date" class="col-form-label">Previous Policy Expiry
                    Date </label>
                <input name="previous_policy_expiry_date" id="previous_policy_expiry_date" type="date"
            ...
            <div class="form-group col-sm-6">
                ...
                <select readonly name="previous_ncb" id="previous_ncb"
        ...
        <div class="row">
            ...
            <div class="form-group col-sm-6">
                <label class="col-form-label" for="insurance_company">Insurance Company <span
                        class="text-danger">*</span></label>
                <select readonly name="insurance_company" id="insurance_company"
