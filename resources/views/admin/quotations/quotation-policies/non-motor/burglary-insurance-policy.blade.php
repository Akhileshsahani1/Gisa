...
<div class="card">
    ...
    <div class="card-body pt-1">
        <div class="row">
            <div class="form-group col-sm-12">
                <label for="premises_type" class="col-form-label">Premises Type</label>
                <input id="premises_type" type="text" class="form-control @error('premises_type') is-invalid @enderror" name="premises_type" value="{{ old('premises_type', isset($quotation->premises_type) ? $quotation->premises_type : '') }}" placeholder="Premises Type">
                @error('premises_type')
