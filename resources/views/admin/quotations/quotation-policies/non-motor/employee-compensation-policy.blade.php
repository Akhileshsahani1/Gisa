...
<div class="card">
    ...
    <div class="card-body pt-1">
        <div class="row">
            <div class="form-group col-sm-6">
                <label for="nature_of_work" class="col-form-label">Nature of Work</label>
                <input id="nature_of_work" type="text"
                    class="form-control @error('nature_of_work') is-invalid @enderror"
                    name="nature_of_work"
            ...
            <div class="form-group col-sm-6">
                ...
                <input id="risk_location" type="text"
                    class="form-control @error('risk_location') is-invalid @enderror"
                    name="risk_location"
                    value="{{ old('risk_location') }}"
            ...
            <div class="form-group col-sm-6">
                <label for="total_no_of_work" class="col-form-label">Total No. of Work</label>
                <input id="total_no_of_work" type="number"
                    class="form-control @error('total_no_of_work') is-invalid @enderror"
                    name="total_no_of_work"
                    value="{{ old('total_no_of_work') }}"
                    placeholder="Total No. of Work">
                @error('total_no_of_work')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
                @enderror
...
<div class="card">
    ...
    <div class="card-body">
        <div class="row">
            ...
            <div class="form-group col-md-6">
                <label for="work_order" class="col-form-label">Upload Work Order </label>
                <input id="work_order" type="file"
                    class="form-control @error('work_order') is-invalid @enderror" name="work_order">
                @error('work_order')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
