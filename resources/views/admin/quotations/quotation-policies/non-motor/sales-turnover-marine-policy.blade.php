...
<div class="card">
    ...
    <div class="card-body">
        <div class="row">
            ...
            <div class="form-group col-md-6">
                <label for="ca_certificate" class="col-form-label">Upload CA Certificate </label>
                <input id="ca_certificate" type="file"
                    class="form-control @error('ca_certificate') is-invalid @enderror" name="ca_certificate">
                @error('ca_certificate')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
                @enderror
