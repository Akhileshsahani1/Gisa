<div class="card">
    <div class="card-header bg-secondary text-white pb-0">
        <h4 class="card-title">Carrier Legal Libility Policy</h4>
    </div>
...
<div class="card">
    ...
    <div class="card-body pt-1">
        <div class="row">
            <div class="form-group col-sm-6">
                <label for="motor_policy_no" class="col-form-label">Motor Policy No.</label>
                <input id="motor_policy_no" type="text" class="form-control @error('motor_policy_no') is-invalid @enderror" name="motor_policy_no" value="{{ old('motor_policy_no', isset($quotation->motor_policy_no) ? $quotation->motor_policy_no : '') }}" placeholder="Motor Policy No.">
                @error('motor_policy_no')
            ...
            <div class="form-group col-sm-6">
                <label for="motor_policy_expiry_date" class="col-form-label">Motor Policy Expiry Date</label>
                <input id="motor_policy_expiry_date" type="date" class="form-control @error('motor_policy_expiry_date') is-invalid @enderror" name="motor_policy_expiry_date" value="{{ old('motor_policy_expiry_date', isset($quotation->motor_policy_expiry_date) ? $quotation->motor_policy_expiry_date : '') }}" placeholder="Motor Policy Expiry Date">
                @error('motor_policy_expiry_date')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
                @enderror
            ...
            <div class="form-group col-sm-6">
                ...
                <input id="vehicle_no" type="text" class="form-control @error('vehicle_no') is-invalid @enderror" name="vehicle_no" value="{{ old('vehicle_no', isset($quotation->vehicle_no) ? $quotation->vehicle_no : '') }}" placeholder="Vehicle No.">
                @error('vehicle_no')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
            ...
            <div class="form-group col-sm-6">
                <label for="cargo_in_carrier" class="col-form-label">Cargo in Carrier</label>
                <input id="cargo_in_carrier" type="text" class="form-control @error('cargo_in_carrier') is-invalid @enderror" name="cargo_in_carrier" value="{{ old('cargo_in_carrier', isset($quotation->cargo_in_carrier) ? $quotation->cargo_in_carrier : '') }}" placeholder="Cargo in Carrier">
                @error('cargo_in_carrier')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
                @enderror
...
<div class="card">
    ...
    <div class="card-body">
        <div class="row">
            ...
            <div class="form-group col-md-6">
                <label for="motor_policy" class="col-form-label">Upload Motor Policy </label>
                <input id="motor_policy" type="file"
                    class="form-control @error('motor_policy') is-invalid @enderror" name="motor_policy">
                @error('motor_policy')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
