...
<div class="card">
    ...
    <div class="card-body pt-1">
        <div class="row">
            <div class="form-group col-sm-12">
                <label for="machine_description" class="col-form-label">Machine Description</label>
                <input id="machine_description" type="text" class="form-control @error('machine_description') is-invalid @enderror" name="machine_description" value="{{ old('machine_description', isset($quotation->machine_description) ? $quotation->machine_description : '') }}" placeholder="Machine Description">
                @error('machine_description')
            ...
            <div class="form-group col-sm-12">
                <label for="machine_sno" class="col-form-label">Machine S No. / Chassis No.</label>
                <input id="machine_sno" type="text" class="form-control @error('machine_sno') is-invalid @enderror" name="machine_sno" value="{{ old('machine_sno', isset($quotation->machine_sno) ? $quotation->machine_sno : '') }}" placeholder="Machine S No. / Chassis No.">
                @error('machine_sno')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
...
<div class="card">
    ...
    <div class="card-body">
        <div class="row">
            ...
            <div class="form-group col-md-6">
                <label for="new_machinery_quotation" class="col-form-label">Upload New Machinery Quotation </label>
                <input id="new_machinery_quotation" type="file"
                    class="form-control @error('new_machinery_quotation') is-invalid @enderror" name="new_machinery_quotation">
                @error('new_machinery_quotation')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
                @enderror
            ...
            <div class="form-group col-md-6">
                <label for="machinery_list" class="col-form-label">Upload Machinery List </label>
                <input id="machinery_list" type="file"
                    class="form-control @error('machinery_list') is-invalid @enderror" name="machinery_list">
                @error('machinery_list')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
                @enderror
