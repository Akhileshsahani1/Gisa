...
@section('content')
    <div class="container-fluid">
        ...
        <form id="quotationForm" method="POST" action="{{ route('admin.quotations.update', $quotation->id) }}" enctype="multipart/form-data">
            @csrf
            @method('PUT')
...
@endsection
@push('scripts')
  @include('admin.quotations.edit-utilities')
@endpush
