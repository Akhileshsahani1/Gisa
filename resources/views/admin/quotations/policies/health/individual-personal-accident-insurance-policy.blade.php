<div class="card">
    <div class="card-header bg-secondary text-white pb-0">
        <h4 class="card-title">Individual Personal Accident Insurance Policy</h4>
    </div>
        ...
        <div class="row">
            ...
            <div class="form-group col-sm-6">
                ...
                <select name="previous_coverage_table" id="previous_coverage_table"
                    class="form-select business_type_new @error('previous_coverage_table') is-invalid @enderror">
                    <option value="">Choose Coverage Table</option>
                    <option value="Death / TTD" {{ old('previous_coverage_table') == 'Death / TTD' ? 'selected' : '' }}>Death / TTD</option>
                    <option value="Death / PTD" {{ old('previous_coverage_table') == 'Death / PTD' ? 'selected' : '' }}>Death / PTD
                    </option>
                    <option value="TTD" {{ old('previous_coverage_table') == 'TTD' ? 'selected' : '' }}>TTD</option>
                    <option value="Death" {{ old('previous_coverage_table') == 'Death' ? 'selected' : '' }}>Death
                    </option>
                </select>
