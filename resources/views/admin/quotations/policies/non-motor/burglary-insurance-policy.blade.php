<div class="card">
    <div class="card-header bg-secondary text-white pb-0">
        <h4 class="card-title">Burglary Insurance Policy</h4>
    </div>
...
<div class="card">
                <div class="card-header bg-secondary text-white pb-0">
                    <h4 class="card-title">Item Description and Sum Insured Details</h4>
                </div>
        <div class="card-body pt-1">
            <div class="row">
                <table>
                    <tr>
                        ...
                        <th>Item Sum Insured</th>
                    </tr>
                    <tr>
                        <td><input id="" type="text" class="form-control mt-2" value="" placeholder="Enter S.No"></td>
                        <td><input id="" type="text" class="form-control mt-2" value="" placeholder="Enter Item Description"></td>
                        <td><input id="" type="text" class="form-control mt-2" value="" placeholder="Enter Item Sum Insured"></td>
                    </tr>
                    <tr>
                        <td><input id="" type="text" class="form-control mt-2" value="" placeholder="Enter S.No"></td>
                        <td><input id="" type="text" class="form-control mt-2" value="" placeholder="Enter Item Description"></td>
...
<div class="card">
    <div class="card-header bg-secondary text-white pb-0">
        <h4 class="card-title">First Loss Basis</h4>
    </div>
    <div class="card-body pt-1">
        <div class="row">
        <div class="form-group col-sm-12">
                <label class="col-form-label" for="business_type">First Loss Basis<span class="text-danger">*</span></label>
                <input id="" type="text" class="form-control" value="" placeholder="Enter First Loss Basis">
            </div>
        </div>
    </div>
</div>
