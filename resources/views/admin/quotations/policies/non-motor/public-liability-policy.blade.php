<div class="card">
    <div class="card-header bg-secondary text-white pb-0">
        <h4 class="card-title">Public Liability Policy</h4>
    </div>
        ...
        <div class="row">
            <div class="form-group col-sm-12">
                ...
                <select name="policy_type" id="policy_type"
                    class="form-select @error('policy_type') is-invalid @enderror">
                    <option value="">Choose Policy Type</option>
                    <option value="Industrial" {{ old('policy_type', isset($quotation->policy_type) ? $quotation->policy_type : '') == 'Industrial' ? 'selected' : '' }}>Industrial</option>
                    <option value="Non Industrial" {{ old('policy_type', isset($quotation->policy_type) ? $quotation->policy_type : '') == 'Non Industrial' ? 'selected' : '' }}>Non Industrial
                    </option>
                    <option value="ACT" {{ old('policy_type', isset($quotation->policy_type) ? $quotation->policy_type : '') == 'ACT' ? 'selected' : '' }}>ACT</option>
                </select>
                @error('policy_type')
        ...
        <div class="row">
            ...
            <div class="form-group col-sm-6">
                ...
                <input id="erf_fund" type="text"
                    ...
                    name="erf_fund"
                    value="{{ old('erf_fund', isset($quotation->erf_fund) ? $quotation->erf_fund : '') }}"
