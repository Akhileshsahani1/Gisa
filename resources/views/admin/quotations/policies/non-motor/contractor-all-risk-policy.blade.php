<div class="card">
    <div class="card-header bg-secondary text-white pb-0">
        <h4 class="card-title">Contractor All Risk Insurance Policy</h4>
    </div>
    ...
    <div class="card-body pt-1">
        <div class="row">
            <div class="form-group col-sm-12">
                ...
                <input id="project_description" type="text" class="form-control @error('project_description') is-invalid @enderror" name="project_description" value="{{ old('project_description', isset($quotation->project_description) ? $quotation->project_description : '') }}" placeholder="Project Description">
            ...
            <div class="form-group col-sm-6">
                <label for="project_period" class="col-form-label">Project Period</label>
                <input id="project_period" type="text" class="form-control @error('project_period') is-invalid @enderror" name="project_period" value="{{ old('project_period', isset($quotation->project_period) ? $quotation->project_period : '') }}" placeholder="Project Period">
                @error('project_period')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
                @enderror
            ...
            <div class="form-group col-sm-6">
                <label for="extended_maintenance_period" class="col-form-label">Extended Maintenance Period</label>
                <input id="extended_maintenance_period" type="text" class="form-control @error('extended_maintenance_period') is-invalid @enderror" name="extended_maintenance_period" value="{{ old('extended_maintenance_period', isset($quotation->extended_maintenance_period) ? $quotation->extended_maintenance_period : '') }}" placeholder="Extended Maintenance Period">
                @error('extended_maintenance_period')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
                @enderror
...
<div class="card">
    ...
    <div class="card-body">
        <div class="row">
            ...
            <div class="form-group col-md-6">
                <label for="letter_of_award" class="col-form-label">Upload Letter of Award (L.O.A) </label>
                <input id="letter_of_award" type="file"
                    class="form-control @error('letter_of_award') is-invalid @enderror" name="letter_of_award">
                @error('letter_of_award')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
                @enderror
