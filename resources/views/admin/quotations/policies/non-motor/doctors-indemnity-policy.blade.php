<div class="card">
    <div class="card-header bg-secondary text-white pb-0">
        <h4 class="card-title">Doctors Indemnity Policy</h4>
    </div>
...
<div class="card">
    ...
    <div class="card-body pt-1">
        <div class="row">
            <div class="form-group col-sm-12">
                <label for="doctor_specialty" class="col-form-label">Doctor Specialty</label>
                <select name="doctor_specialty" id="doctor_specialty"
                    class="form-select @error('doctor_specialty') is-invalid @enderror">
                    <option value="">Choose Doctor Specialty</option>
                    <option value="Industrial" {{ old('doctor_specialty', isset($quotation->doctor_specialty) ? $quotation->doctor_specialty : '') == 'Industrial' ? 'selected' : '' }}>Industrial</option>
                    <option value="Non Industrial" {{ old('doctor_specialty', isset($quotation->doctor_specialty) ? $quotation->doctor_specialty : '') == 'Non Industrial' ? 'selected' : '' }}>Non Industrial
                    </option>
                    <option value="ACT" {{ old('doctor_specialty', isset($quotation->doctor_specialty) ? $quotation->doctor_specialty : '') == 'ACT' ? 'selected' : '' }}>ACT</option>
                </select>
                @error('doctor_specialty')
