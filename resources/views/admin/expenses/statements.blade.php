                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="card-body pt-1">
                            ...
                            <div class="row offset-md-6 col-md-6">
                                ...
                                <table class="table table-striped dt-responsive nowrap">
                                    ...
                                    <tbody>
                                        ...
                                        <tr role="row">
                                            ...
                                            <td class="text-end">{{ $paid_amount }}</td>
                                        </tr>

                                         <tr role="row">
                                            <td class="table-user">Balance Due:</td>
                            ...
                            <div class="col-md-12 table-responsive">
                                <table id="basic-datatable" class="table table-stripedx dt-responsive nowrap w-100">
                                    ...
                                    <tbody>
                                        ...
                                        @endforeach
                                            <tr role="row">
                                                <td colspan="5" style="background-color: wheat; text-align: right;" class="table-user">Total Amount </td>
                                                <td colspan="1">₹{{ abs($balance) }}</td>
                                            </tr>
                                    </tbody>
                                </table>
                            </div>
