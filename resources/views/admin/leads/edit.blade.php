...
@section('content')
    <div class="container-fluid">
        ...
        <form id="leadForm" method="POST" action="{{ route('admin.leads.update', $lead->id) }}"
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <select name="customer_type" id="customer_type" class="form-select">
                                        <option value="inword" @if($lead->customer_type == 'inword') selected @endif>InWord</option>
                                        <option value="outword" @if($lead->customer_type == 'outword') selected @endif>OutWord</option>
                                    </select>
                                    @error('customer_type')
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <select id="salutation" class="form-select @error('salutation') is-invalid @enderror"
                                        ...
                                        <option value="M/s."
                                            {{ old('salutation', $lead->salutation) == 'M/s.' ? 'selected' : '' }}>M/s.
                                        </option>
                                        <option value="Mr."
                                            {{ old('salutation', $lead->salutation) == 'Mr.' ? 'selected' : '' }}>Mr.
                                        </option>
                                        <option value="Ms."
                                            {{ old('salutation', $lead->salutation) == 'Ms.' ? 'selected' : '' }}>Ms.
                                        </option>
                                        <option value="Mrs."
                                            {{ old('salutation', $lead->salutation) == 'Mrs.' ? 'selected' : '' }}>Mrs.
                                        </option>
                                    </select>
                                    @error('salutation')
                                        <div class="invalid-feedback">
                                ...
                                <div
                                    class="form-group col-md-4 company_fields @if ($lead->salutation != 'M/s.' && !$errors->has('company_name')) hidden @endif">
                                ...
                                <div
                                    ...
                                    <input id="company_phone" type="text"
                                        ...
                                        name="company_phone" value="{{ old('company_phone', $lead->company_phone) }}"
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input id="firstname" type="text"
                                        ...
                                        value="{{ old('firstname', $lead->firstname) }}"
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input id="lastname" type="text"
                                        ...
                                        value="{{ old('lastname', $lead->lastname) }}"
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" class="form-control @error('whats_app') is-invalid @enderror"
                                        ...
                                        value="{{ old('whats_app', $lead->whats_app) }}">
                                    @error('whats_app')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="form-group col-md-2">
                                    ...
                                    <select id="gender" class="form-select @error('gender') is-invalid @enderror"
                                        ...
                                        <option value="Other"
                                            {{ old('gender', $lead->gender) == 'Other' ? 'selected' : '' }}>Other
                                        </option>
                                    </select>
                                    @error('gender')
                                        <div class="invalid-feedback">
                                ...
                                <div class="form-group col-md-2">
                                    ...
                                    <input id="date_of_birth" type="date"
                                        ...
                                        name="date_of_birth" value="{{ old('date_of_birth', $lead->date_of_birth) }}">
                                    @error('date_of_birth')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <select id="lead_type" class="form-select @error('lead_type') is-invalid @enderror"
                                        ...
                                        <option value="{{ $type->value }}" {{ old('lead_type',$lead->lead_type) == $type->value ? 'selected' : '' }}>{{ $type->value }}
                                        </option>
                                        @endforeach
                                    </select>
                                    @error('lead_type')
                                ...
                                <div class="form-group col-md-6">
                                    <label for="lead_source" class="col-form-label">Lead Source <span
                                            ...
                                            <option value="{{ $source->value }}" {{ old('lead_source',$lead->lead_source) == $source->value ? 'selected' : '' }}>{{ $source->value }}
                                            </option>
                                            @endforeach
                                        </select>
                                    @error('lead_source')
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <select id="lead_status"
                                        ...
                                        <option value="{{ $status->value }}" {{ old('lead_status',$lead->lead_status) == $status->value ? 'selected' : '' }}>{{ $status->value }}
                                        </option>
                                        @endforeach
                                    </select>
                                    @error('lead_status')
                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body pt-1">
                            <div class="row">
                                <div class="form-group col-md-4">
                                    <label class="col-form-label" for="policy_id">Type of Product <span
                                            class="text-danger">*</span></label>
                                    <select name="policy_id" id="policy_id"
                                        ...
                                        @foreach ($policies as $policy)
                                            <option value="{{ $policy->id }}"
                                                {{ old('policy_id', $lead->policy_id) == $policy->id ? 'selected' : '' }}>
                                                {{ $policy->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group col-md-4">
                                    <label class="col-form-label" for="policy_type_id">Type of Insurance Policy <span
                                            class="text-danger">*</span></label>
                                ...
                                <div class="form-group col-sm-4">
                                    ...
                                    <input id="previous_policy_expiry_date" type="date"
                                        ...
                                        value="{{ old('previous_policy_expiry_date', $lead->previous_policy_expiry_date) }}"
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <textarea id="special_remark" class="form-control @error('special_remark') is-invalid @enderror"
                                        name="special_remark" rows="2" placeholder="Write Specific Remark here">{{ old('special_remark', $lead->special_remark) }}</textarea>
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <select name="is_claimed" id="is_claimed"
                                        ...
                                        <option value="no" @if($lead->is_claimed == 'no') selected @endif>No</option>
                                        <option value="yes" @if($lead->is_claimed == 'yes') selected @endif>Yes</option>
                                    </select>
                                    @error('is_claimed')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                        ...
                        <div class="card-body pt-1" >
                            <div id="add-document-div">
                             @foreach($lead->attachments as $key => $attachment)
                              <div class="row mt-2" id="doucment-row-{{ $key}}">
                                 <div class="col-sm-5">
                                    
                                   <input type="text" name="documents[{{ $key}}][title]" id="input" class="form-control" value="{{ $attachment->title }}" required="required" placeholder="Name of Document" readonly>
                                  </div>
                                   <div class="col-md-5">
                                    <a href="{{ asset('storage/uploads/documents/'.$attachment->name) }}" target="_blank" download="">
                                    <div class="me-2 mt-2 mb-2 border text-center py-4" style="width: 150px; height: 100px;">{{ substr($attachment->name,13) }}</div>
                                    <input type="hidden" class="document" name="documents[{{ $key}}][document]" value="{{ $attachment->name }}">
                                    </a>
                                    </div>
                                   <div class="col-sm-2" >
                                    <button type="button" class="btn btn-danger" onClick=$("#doucment-row-{{ $key }}").remove()>Remove</button>
                                    </div> 
                                </div>
                             @endforeach
...
@push('scripts')
        ...
        function getProductType() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $('#policy_type_id').val("{{ $lead->policy_type_id }}");
                }
                ...
                if (input.files) {
                    ...
                    for (i = 0; i < filesAmount; i++) {
                        ...
                        $($.parseHTML('<span>')).css('width', '150px')
                            .css('height', '70px').attr('class', 'me-2 mt-2 mb-2 border text-center py-4')
    ...
    <script type="text/javascript">
        var document_row = '{{ count($lead->attachments) }}';
