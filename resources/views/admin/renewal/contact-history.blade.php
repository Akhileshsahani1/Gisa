    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-2 mt-2">
                <a href="{{ route('admin.renewal.show',$renewal->id) }}" class="btn btn-sm btn-dark"><i
                    class="mdi mdi-chevron-double-left me-1"></i>Back</a>
            </div>
        </div>
        @include('admin.includes.flash-message')
        <div class="row">
            @forelse ($renewal->contactHistories as $history)
                                                ...
                                                <tr>
                                                    <td style="width: 100%"><span class="fw-bold">Call Recording
                                                        ...
                                                        @isset($history->attachment_call_recording)
                                                            <a href="{{ asset('storage/uploads/leads/' . $renewal->id . '/history' . '/' . $history->attachment_call_recording) }}"
                                                ...
                                                <tr>
                                                    <td style="width: 100%"><span class="fw-bold">Email Attachment
                                                        ...
                                                        @isset($history->attachment_email)
                                                            <a href="{{ asset('storage/uploads/leads/' . $renewal->id . '/history' . '/' . $history->attachment_email) }}"
                                                ...
                                                <tr>
                                                    <td style="width: 100%"><span class="fw-bold">WhatsApp Attachment
                                                        ...
                                                        @isset($history->attachment_whatsapp)
                                                            <a href="{{ asset('storage/uploads/leads/' . $renewal->id . '/history' . '/' . $history->attachment_whatsapp) }}"
