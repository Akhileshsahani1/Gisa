...
<div class="card mb-0 mt-1" id="contacted_div" style="display: none;">
    <div class="card-header bg-secondary text-white pb-0">
        <p class="card-title fw-bold">Renewal Contact History</p>
    </div>
    <div class="card-body pt-1">
        <div class="form-group col-md-12">
            ...
            <select id="contacted_via" class="form-select @error('contacted_via') is-invalid @enderror"
                ...
                <option value="Via Phone" {{ old('contacted_via') == 'Via Phone' ? 'selected' : '' }}>
                    Via Phone
                </option>
                <option value="Via Email" {{ old('contacted_via') == 'Via Email' ? 'selected' : '' }}>
                    Via Email
                </option>
                <option value="Via WhatsApp" {{ old('contacted_via') == 'Via WhatsApp' ? 'selected' : '' }}>
                    Via WhatsApp
                </option>
                <option value="Via Meet" {{ old('contacted_via') == 'Via Meet' ? 'selected' : '' }}>
                    Via Meet
                </option>
            </select>
            @error('contacted_via')
            ...
            <div class="row">
                <div class="form-group col-sm-12">
                    ...
                    <input id="caller_name" type="text"
                        ...
                        value="{{ old('caller_name') }}" placeholder="Enter Caller Name">
                    @error('caller_name')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="form-group col-sm-12">
                    ...
                    <input id="calling_date" type="date"
                        ...
                        value="{{ old('calling_date') }}" placeholder="Calling Date">
                    @error('calling_date')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="form-group col-sm-12">
                    ...
                    <input id="calling_time" type="time"
                        ...
                        value="{{ old('calling_time') }}" placeholder="Calling Time">
                    @error('calling_time')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="form-group col-sm-12">
                    ...
                    <textarea id="comment" class="form-control @error('comment') is-invalid @enderror" name="comment" rows="2" placeholder="Write Comment here">{{ old('comment') }}</textarea>
                    @error('comment')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
            ...
            <div class="row">
                <div class="form-group col-sm-12">
                    ...
                    <input id="email_sent_date" type="date"
                        ...
                        value="{{ old('email_sent_date') }}" placeholder="Email Sent Date">
                ...
                <div class="form-group col-sm-12">
                    ...
                    <input id="email_sender_id" type="email"
                        ...
                        value="{{ old('email_sender_id') }}" placeholder="Enter Email Sender ID">
                ...
                <div class="form-group col-sm-12">
                    ...
                    <input id="email_receiver_id" type="email"
                        ...
                        name="email_receiver_id" value="{{ old('email_receiver_id') }}"
                ...
                <div class="form-group col-sm-12">
                    ...
                    <textarea id="email_body" class="form-control @error('email_body') is-invalid @enderror" name="email_body" rows="2" placeholder="Write Email Body here">{{ old('email_body') }}</textarea>
                    @error('email_body')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
            ...
            <div class="row">
                <div class="form-group col-sm-12">
                    ...
                    <input id="message_date" type="date"
                        ...
                        value="{{ old('message_date') }}" placeholder="Message Date">
                    @error('message_date')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="form-group col-sm-12">
                    ...
                    <input id="whats_app_from-dial-code" name="whats_app_from_dialcode" type="hidden"
                        value="{{ old('whats_app_from_dialcode') }}">
                </div>
                <div class="form-group col-sm-12">
                    ...
                    <input id="whats_app_to-dial-code" name="whats_app_to_dialcode" type="hidden"
                        value="{{ old('whats_app_to_dialcode') }}">
                </div>
                <div class="form-group col-sm-12">
                    ...
                    <textarea id="whatsapp_message" class="form-control @error('whatsapp_message') is-invalid @enderror"
                        ...
                        placeholder="Write Whatsapp Message here">{{ old('whatsapp_message') }}</textarea>
            ...
            <div class="row">
                <div class="form-group col-sm-12">
                    ...
                    <input id="who_meet" type="text"
                        ...
                        value="{{ old('who_meet') }}" placeholder="Who Meet ?">
                    @error('who_meet')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="form-group col-sm-12">
                    ...
                    <input id="whom_meet" type="text"
                        ...
                        value="{{ old('whom_meet') }}" placeholder="Whom Meet ?">
                    @error('whom_meet')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="form-group col-sm-12">
                    ...
                    <input id="meeting_date" type="date"
                        ...
                        value="{{ old('meeting_date') }}" placeholder="Meeting Date">
                    @error('meeting_date')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="form-group col-sm-12">
                    ...
                    <input id="meeting_time" type="time"
                        ...
                        value="{{ old('meeting_time') }}" placeholder="Meeting Time">
                    @error('meeting_time')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="form-group col-sm-12">
                    ...
                    <input id="meeting_location" type="text"
                        ...
                        name="meeting_location" value="{{ old('meeting_location') }}"
                ...
                <div class="form-group col-sm-12">
                    ...
                    <textarea id="meeting_discussion" class="form-control @error('meeting_discussion') is-invalid @enderror"
                        ...
                        placeholder="Write Meeting Discussion here">{{ old('meeting_discussion') }}</textarea>
            ...
            <div class="row">
                <div class="form-group col-sm-12">
                    ...
                    <input id="follow_up_date" type="date"
                        ...
                        value="{{ old('follow_up_date') }}" placeholder="Next Follow Up Date">
                ...
                <div class="form-group col-sm-12">
                    ...
                    <input id="follow_up_time" type="time"
                        ...
                        value="{{ old('follow_up_time') }}" placeholder="follow_up Time">
